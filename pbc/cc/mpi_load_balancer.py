...
#arange = range(nvir)
#irange = range(nocc)
#noob = load_balancer(3)
#noob.set_ranges((arange,irange))
#good2go = True
#while(good2go):
#    good2go, data = noob.slave_set()
#    ##print noob.rank, " doing work on data ", data
#    ###print noob.outblocks[0][data[0]]
#    sleep(0.2)
#    noob.slave_finished()
#
###print noob.rank, "finishing up!"
#good2go = True
